...
const testimonials = [
  {
    ...
    context: "Freelancer → Agency Owner",
    avatar: "👨‍💻",
    ...
    whatChanged: "Clarity on positioning",
    rating: 5,
  },
  {
    id: 2,
    ...
    context: "Solo Consultant → €12K/month",
    avatar: "👩‍💼",
  ...
  },
  {
    ...
    context: "Overwhelmed → Focused & Growing",
    avatar: "👨‍🚀",
  ...
  },
  {
    ...
    context: "Plateaued → Breaking Through",
    avatar: "👩‍🎨",
    ...
    whatChanged: "Confidence in decisions",
    rating: 5,
  },
];
              ...
              >
                ...
                <div className="flex flex-wrap items-center gap-4 mb-8">
                  ...
                  <span className="text-sm text-muted-foreground">
                    What changed the most: <span className="text-foreground font-medium">{activeTestimonial.whatChanged}</span>
                  </span>
                </div>
